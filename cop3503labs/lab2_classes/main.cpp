/*
COP3503c - Programming Fundamentals II - Lab 2
Classes and Objects
Esteban Medero
September 11, 2022
This lab assignemnt is display an understanding of classes and objects in C++. 3 classes linked together are created
to represent a dealership. within each dealership exists showrooms and each showroom has an inventory of vehicles
each with a make, model, year, price, and mileage.
*/
